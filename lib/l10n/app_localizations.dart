...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Protect your privacy, clean your data.'**
  String get subtitle;

  /// No description provided for @startBySelecting.
  ///
  /// In en, this message translates to:
  /// **'Start by selecting a photo'**
  ...
  /// No description provided for @cleanedWith.
  ///
  /// In en, this message translates to:
  /// **'Cleaned with ExifGone ✨'**
  String get cleanedWith;
